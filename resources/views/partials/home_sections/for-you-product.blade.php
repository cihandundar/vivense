@php
    $picksProduct = [
        ...
        [
            'image' => asset('front/assets/images/for-you1.jpg'),
            'discout'=> 20,
            'price'=> 5.945,
            'name'=> " Tulip Köşe Koltuk, Ekru ",
        ],
        [
            'image' => asset('front/assets/images/for-you2.jpg'),
            'price'=> 6.789,
            'paymentImg' => asset('front/assets/images/payment.webp'),
            'name'=> " Ellas Koltuk Takımı, Krem ",
        ],
        [
            'image' => asset('front/assets/images/for-you3.jpg'),
            'discout'=> 20,
            'price'=> 9.099,
        ...
        [
            'image' => asset('front/assets/images/for-you9.jpg'),
            'discout'=> 20,
            'price'=> 6.532,
        ...
        [
            'image' => asset('front/assets/images/for-you4.jpg'),
            'price'=> 3.123,
            'discountImg' => asset('front/assets/images/discount.webp'),
            'name'=> " Henry Midi Portmanto, Minderli ",
        ],
        [
            'image' => asset('front/assets/images/for-you5.jpg'),
            'discout'=> 20,
            'price'=> 10.999,
            'name'=> " Lagomood Side Çalışma Masası, Beyaz Safir Meşe ",
        ],
        [
            'image' => asset('front/assets/images/for-you6.jpg'),
            'price'=> 13.413,
            'discountImg' => asset('front/assets/images/discount.webp'),
            'name'=> "Kitchen Essentials Stoneware Çukur Yemek Tabağı 21 Cm",
        ],
        [
            'image' => asset('front/assets/images/for-you7.jpg'),
            'price'=> 22.949,
